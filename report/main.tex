...
\begin{enumerate}[leftmargin=*]
    ...
    \item \textbf{Empirical evaluation}: We compare four approaches (rule-based, zero-shot LLM, few-shot LLM, hybrid) and demonstrate that our hybrid approach achieves the best F1 (0.9651) at the lowest cost (\$0.01/500 samples).
\end{enumerate}
